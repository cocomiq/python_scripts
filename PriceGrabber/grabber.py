...
def get_gratis_sub_links(browser, links_in):
    ...
    for lnk in links_in:
        ...
        if links_raw:
            ...
            links_sub.append(links_sub)
            # Retrieving minor sub categories
            get_gratis_sub_links(browser, links_sub)

        else:
            get_gratis_item_links(browser, links_sub)
...
def get_gratis_item_links(browser, url_list):
    """
    ...
    while True:
        ...
        for ii in items_data:
            ...
            links_items.append([url_list[2], items_info.find("a").text.strip(), "https://www.gratis.com" + items_info.find("a")["href"]])
