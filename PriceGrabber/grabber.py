...
def get_gratis_sub_links(browser, links_in, links_out):
    """
...
def get_gratis_item_prices(browser, url):
    """
    ...
    for brd in brands:
        brd.find_element_by_xpath("//label/span").text
